...
define plone::site ( $site_name        = $name,
                     ...
                     $has_filestorage  = $plone::params::default_site_has_filestorage,
  ...
  buildout::part { "site_${name}":
    ...
    cfghash      => { recipe           => 'collective.recipe.plonesite',
                      ...
                      before-install   => $has_filestorage ? {
                                            true => "bin/buildout -c site_${site_name}.cfg filestorage:add-mountpoint=true install filestorage",
                                            false => '',
                                          },
